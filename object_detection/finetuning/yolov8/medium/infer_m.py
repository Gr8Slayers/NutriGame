...
# YOLOv8m model yükle 
model = YOLO(r"D:\Desktop\Bitirme\NutriGame\object_detection\finetuning\yolov8\results\weights\best.pt")
...
# Inference
results = model(images, conf=0.2)  # Optimal threshold ekledim

# Output klasörü oluştur
output_dir = r"D:\Desktop\Bitirme\NutriGame\object_detection\finetuning\yolov8\infer_results"
