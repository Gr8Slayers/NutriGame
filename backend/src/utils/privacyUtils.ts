...
export function filterPersonalInformation(message: string): string {
...
export function filterHistoryPersonalInformation<T extends ChatHistoryEntry>(history: T[]): T[] {
